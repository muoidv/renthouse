<div id="leftCol">
    <div id="left-col-nav" class="clearfix">
        <ul style="float: left;">
            ...
            <li id="my-house"><a class="kd-button" href="" id="a-my-house" title="Danh sách nhà tôi đang theo dõi">Nhà Tôi</a></li>
        </ul>
    </div>
...
<div class="leaflet-control-requery leaflet-control" id="refresh-renthouse">
    <a href="#"></a>
    <span style="display: none">Click để tìm kiếm nhà trong khu vực này</span>
</div>
<div class="leaflet-control-locate leaflet-control" id="get-current-location" style="">
    <a href="#" title=""></a>
    <span style="display: none">Click để tìm vị trí của bạn</span>
</div>

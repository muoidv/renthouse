...
/**
 * PosEventPhoto form base class.
 *
 * @method PosEventPhoto getObject() Returns the current form's model object
 *
 * @package    OpenPNE
 * @subpackage form
 ...
 */
abstract class BasePosEventPhotoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pos_event_photo[%s]');

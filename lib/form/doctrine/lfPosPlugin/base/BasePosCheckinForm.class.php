...
/**
 * PosCheckin form base class.
 *
 * @method PosCheckin getObject() Returns the current form's model object
 *
 * @package    OpenPNE
 * @subpackage form
 ...
 */
abstract class BasePosCheckinForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pos_checkin[%s]');

...
/**
 * PosEventFollow form base class.
 *
 * @method PosEventFollow getObject() Returns the current form's model object
 *
 * @package    OpenPNE
 * @subpackage form
 ...
 */
abstract class BasePosEventFollowForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pos_event_follow[%s]');

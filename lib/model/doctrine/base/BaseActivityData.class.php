 ...
 * @method array               getTemplateParam()           Returns the current record's "template_param" value
 ...
 * @method ActivityData        setTemplate()                Sets the current record's "template" value
 * @method ActivityData        setTemplateParam()           Sets the current record's "template_param" value
...
abstract class BaseActivityData extends opDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('template_param', 'array', null, array(
             'type' => 'array',

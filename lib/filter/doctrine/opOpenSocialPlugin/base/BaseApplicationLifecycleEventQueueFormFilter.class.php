...
/**
 * ApplicationLifecycleEventQueue filter form base class.
 *
 * @package    OpenPNE
 * @subpackage filter
 ...
 */
abstract class BaseApplicationLifecycleEventQueueFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('application_lifecycle_event_queue_filters[%s]');
